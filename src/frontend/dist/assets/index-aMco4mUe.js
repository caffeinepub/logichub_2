...
function MathBackground() {
  const symbols = reactExports.useMemo(() => {
    const anims = [
      "animate-float-slow",
      "animate-float-med",
      "animate-float-fast"
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "aria-hidden": "true",
      children: symbols.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
const questions = [
  ...
  },
  {
    ...
    options: ["2", "6", "3"],
    answer: 1,
    explanation: "Делители 12: 1,2,3,4,6,12. Делители 18: 1,2,3,6,9,18. Наибольший общий — 6."
  },
  {
    id: 3,
    text: "Найди НОК(4, 6)",
    options: ["12", "24", "6"],
    answer: 0,
    explanation: "Кратные 4: 4,8,12... Кратные 6: 6,12... Наименьшее общее — 12."
  },
  {
    id: 4,
...
const learningTopics = [
  ...
  },
  {
    ...
    content: "Дробь сокращается, если делить числитель и знаменатель на одно число.\nПример: 8/12 → делим на 4 → 2/3"
  },
  {
    id: 3,
    title: "3. Сложение дробей",
    content: "Если знаменатели одинаковые — складываем числители.\nЕсли разные — приводим к общему знаменателю."
  },
  {
    id: 4,
  ...
  },
  {
    id: 7,
    title: "7. НОД",
    content: "Наибольший общий делитель — это самое большое число, на которое делятся оба числа.\nПример: НОД(12, 18) = 6"
  },
  {
    id: 8,
    title: "8. НОК",
    content: "Наименьшее общее кратное — это самое маленькое число, которое делится на оба числа.\nПример: НОК(4, 6) = 12"
  },
  { id: 9, title: "9. Десятичные дроби", content: "0.5 = 1/2\n0.25 = 1/4" },
  {
    id: 10,
    title: "10. Нахождение части числа",
    content: "Чтобы найти дробь от числа — умножаем число на дробь.\nПример: 1/4 от 20 = 5"
  }
];
function r(e) {
  var t, f, n = "";
...
const LABELS$1 = ["А", "Б", "В"];
function ExplanationScreen({
  question,
  onBack,
  onNext
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background px-5 pt-6 pb-8 animate-slide-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppBadge, { children: "Объяснение" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-body", children: [
        "Задание ",
        question.id
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/10 rounded-2xl p-4 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-primary font-medium", children: question.text }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-success/15 border border-success/30 rounded-2xl px-5 py-4 mb-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-success flex items-center justify-center text-success-foreground font-display font-bold text-sm", children: LABELS$1[question.answer] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Правильный ответ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-display font-bold text-foreground", children: question.options[question.answer] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-success text-xl", children: "✓" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl p-5 shadow-xs flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm text-muted-foreground mb-2 uppercase tracking-wider", children: "Объяснение" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-foreground text-base leading-relaxed", children: question.explanation })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-col gap-3", children: [
      onNext && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: "← Вернуться к заданиям"
        }
      )
    ] })
  ] });
}
function HomeScreen({ onTasks, onLearning }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-primary pt-14 pb-16 px-6 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-8 -right-8 w-40 h-40 rounded-full bg-white/10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 -right-4 w-20 h-20 rounded-full bg-white/10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-10 -left-10 w-36 h-36 rounded-full bg-white/10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/20 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-display font-bold text-white", children: "L" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-display font-bold text-white tracking-tight", children: "LogicHub" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 mt-2 font-body text-sm", children: "Логические задачи для школьников" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 inline-flex items-center gap-1.5 bg-white/20 rounded-full px-3 py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-body", children: "📚 6 класс · Дроби, НОД, НОК" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center px-6 gap-4 pb-20 mt-6 animate-slide-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function LearningScreen({ onSelectTopic, onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background px-5 pt-6 pb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppBadge, { children: "ОБУЧЕНИЕ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppBadge, { variant: "light", children: "Для 5–6 классов" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-body mt-2 mb-6", children: "Выбери тему для изучения" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 flex-1", "data-ocid": "learning.list", children: learningTopics.map((topic, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 rounded-xl bg-primary/15 flex items-center justify-center text-xl flex-shrink-0", children: TOPIC_ICONS[i] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body font-medium text-foreground", children: topic.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-muted-foreground", children: "›" })
        ]
      },
      topic.id
    )) }),
...
function LearningTopicScreen({
  topic,
  onBack,
  onNext
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background px-5 pt-6 pb-8 animate-slide-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AppBadge, { children: [
      "Тема ",
      topic.id
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-display font-bold text-foreground mb-4", children: topic.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-2xl p-5 shadow-xs flex-1", children: topic.content.split("\n").map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
...
function SplashScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-background relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-6 animate-splash-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-3xl bg-primary flex items-center justify-center shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl font-display font-bold text-primary-foreground", children: "L" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-display font-bold text-foreground tracking-tight", children: "LogicHub" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1 font-body", children: "Логические задачи для школьников" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "загрузка..." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dot-pulse text-primary flex", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 bg-primary/10 border-t border-primary/20 px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-center text-primary font-body", children: "💡 Совет: пока идёт загрузка, настройся на мозговую активность" }) })
  ] });
}
function TaskListScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background px-5 pt-6 pb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppBadge, { children: "ЗАДАНИЯ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppBadge, { variant: "light", children: "Для 5–6 классов" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-body mt-2 mb-6", children: "Выбери задание из списка ниже" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 rounded-full bg-primary/15 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3 flex-1", "data-ocid": "task_list.list", children: questions.map((q) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `aspect-square rounded-2xl font-display font-bold text-lg flex items-center justify-center transition-all active:scale-90 shadow-xs ${done ? "bg-success text-success-foreground" : "bg-primary text-primary-foreground hover:bg-primary/90"}`,
          children: done ? "✓" : q.id
        },
        q.id
      );
...
function TaskScreen({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background px-5 pt-6 pb-8 animate-slide-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AppBadge, { children: [
        "Задание ",
        question.id
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-2xl p-6 shadow-card mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-display font-bold text-foreground leading-snug", children: question.text }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", "data-ocid": "task.options.list", children: question.options.map((option, idx) => {
      let style2 = "bg-card border border-border text-foreground";
      if (isAnswered) {
        if (idx === question.answer) {
          style2 = "bg-success text-success-foreground border-transparent";
        } else if (idx === selected) {
          style2 = "bg-destructive text-destructive-foreground border-transparent";
        } else {
          style2 = "bg-card border border-border text-muted-foreground opacity-50";
        }
      }
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          disabled: isAnswered,
          className: `w-full rounded-2xl px-5 py-4 text-left font-body font-medium text-base transition-all active:scale-95 flex items-center gap-3 shadow-xs ${style2}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-current/10 flex items-center justify-center font-display font-bold text-sm flex-shrink-0", children: LABELS[idx] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: option }),
            isAnswered && idx === question.answer && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-lg", children: "✓" }),
            isAnswered && idx === selected && idx !== question.answer && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-lg", children: "✗" })
          ]
        },
        `opt-${question.id}-${idx}`
      );
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `rounded-2xl px-5 py-3 text-sm font-body font-medium ${selected === question.answer ? "bg-success/20 text-success" : "bg-destructive/15 text-destructive"}`,
              children: selected === question.answer ? "🎉 Правильно! Отличная работа!" : "❌ Неверно. Посмотри объяснение."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
function App() {
  ...
  const [currentTaskId, setCurrentTaskId] = reactExports.useState(1);
  const [currentTopicId, setCurrentTopicId] = reactExports.useState(1);
  const [completedIds, setCompletedIds] = reactExports.useState(/* @__PURE__ */ new Set());
  reactExports.useEffect(() => {
    const timer = setTimeout(() => setScreen("home"), 1800);
    return () => clearTimeout(timer);
  }, []);
  const currentQuestion = questions.find((q) => q.id === currentTaskId) ?? questions[0];
  const currentTopic = learningTopics.find((t) => t.id === currentTopicId) ?? learningTopics[0];
  const nextTaskId = currentTaskId < questions.length ? currentTaskId + 1 : null;
  const nextTopicId = currentTopicId < learningTopics.length ? currentTopicId + 1 : null;
  function handleCorrect(id) {
    setCompletedIds((prev) => /* @__PURE__ */ new Set([...prev, id]));
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen max-w-[430px] mx-auto overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MathBackground, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
      screen === "splash" && /* @__PURE__ */ jsxRuntimeExports.jsx(SplashScreen, {}),
      ...
      screen === "taskList" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TaskListScreen,
        {
          completedIds,
          onSelectTask: (id) => {
      ...
      screen === "task" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        TaskScreen,
        {
      ...
      screen === "explanation" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ExplanationScreen,
        {
          question: currentQuestion,
          onBack: () => setScreen("taskList"),
      ...
      screen === "learning" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        LearningScreen,
        {
          onSelectTopic: (id) => {
      ...
      screen === "learningTopic" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        LearningTopicScreen,
        {
          topic: currentTopic,
